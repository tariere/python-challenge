...
with open(election_csv, newline="", encoding='utf-8') as csvfile:
    ...
    with open (outputpath, 'w') as report:
        ...
        #This is just to print the text/formatting elements of my report before I get to specific values.  This goes for any text only other text only print commands in the script as well.  The commands are listed twice, once to print to the console and once to print to my report.
